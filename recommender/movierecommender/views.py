...
# A view to provide movie recommendations list for the HTML template
...
def generate_movies_context():
    context = {}
    # Show only movies in recommendation list, Sorted by vote_average in desc, Get recommended movie counts
